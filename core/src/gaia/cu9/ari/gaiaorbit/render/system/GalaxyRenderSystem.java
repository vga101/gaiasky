    ...
    public void renderStud(List<IRenderable> renderables, ICamera camera) {
        ...
        if (size > 0) {
            ...
            if (GlobalConf.scene.GALAXY_3D) {
                ...
                quadProgram.setUniformf("u_alpha", 0.01f * mw.opacity * alphas[mw.ct.ordinal()]);
                ...
                shaderProgram.setUniformf("u_alpha", mw.opacity * alphas[mw.ct.ordinal()] * 0.2f);
             ...
             * IMAGE RENDERER
             */
            mw.mc.setTransparency(mw.opacity * alphas[mw.ct.ordinal()] * (GlobalConf.scene.GALAXY_3D ? 0.8f : 0.9f));
