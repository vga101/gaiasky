...
public class BillboardRenderSystem extends AbstractRenderSystem implements IObserver {
    ...
    public BillboardRenderSystem(RenderGroup rg, int priority, float[] alphas, ShaderProgram shaderProgram,
	    boolean useStarColorTransit, String tex0, int ctindex, float w, float h) {
     ...
     */
    public BillboardRenderSystem(RenderGroup rg, int priority, float[] alphas, ShaderProgram shaderProgram,
	    boolean useStarColorTransit, String tex0, int ctindex) {
