...
public class Loc extends AbstractPositionEntity implements I3DTextRenderable {
	...
	double cosalpha = aux.add(location3d.x, location3d.y, location3d.z).nor()
		.dot(GaiaSky.instance.cam.getDirection().nor());
	...
	shader.setUniformf("a_viewAngle",
		(float) (viewAngleApparent * ((ModelBody) parent).locVaMultiplier * Constants.U_TO_KM));
