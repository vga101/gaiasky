...
public class GaiaCatalogWindow extends CollapsibleWindow {
    ...
    private static String URL_GAIA_CSV_SOURCE = "http://gaia.ari.uni-heidelberg.de/singlesource/search?f=csv&id=";

    private static String URL_GAIA_JSON_SOURCE = "http://gaia.ari.uni-heidelberg.de/singlesource/search?f=json&id=";
