 ...
 * All properties except {@link Camera#near}, {@link Camera#far} and
 * {@link #offset} will be overwritten on every call to {@link #update()} based
 * on the tracked values from the head mounted display. The {@link #offset}
