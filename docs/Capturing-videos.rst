...
to the official `ffmpeg documentation <http://ffmpeg.org/documentation.html>`__. Also, `here <https://en.wikibooks.org/wiki/FFMPEG_An_Intermediate_Guide/image_sequence>`__ is a good resource on creating images with ``ffmpeg`` from image sequences.
