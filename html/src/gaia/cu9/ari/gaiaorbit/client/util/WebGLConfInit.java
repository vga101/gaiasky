...
public class WebGLConfInit extends ConfInit {
    ...
    public void initGlobalConf() throws Exception {
        ...
        sc.initialize(1, 2500, 6f, 0f, 50, 2.1f, 1866f, 2286f, 13, true, false, 50.0f, VISIBILITY, 2, 0, 0f, 1.6e-7f, 0f, 0.1f, 0.8f, false, 0.6f, 1.5f, false, 20f, 1e1f, 1f, true, 100, true);
